(function () {
    ...
    const DEVTOOLS_DOCS_URL = 'https://github.com/darkreader/darkreader/blob/main/CONTRIBUTING.md';
    ...
    function Body({ data, actions }) {
        ...
        const dialog = context && context.store.isDialogVisible ? (m$1(MessageBox, { caption: "Are you sure you want to remove current changes? You cannot restore them later.", onOK: reset, onCancel: hideDialog })) : null;
        function reset() {
            context.store.isDialogVisible = false;
            wrapper.reset();
            setState({ errorText: null });
        ...
        return (m$1("body", null,
            m$1("header", null,
                m$1("img", { id: "logo", src: "../assets/images/darkreader-type.svg", alt: "Dark Reader" }),
                m$1("h1", { id: "title" }, "Developer Tools")),
            m$1("h3", { id: "sub-title" }, wrapper.header),
            m$1("textarea", { id: "editor", onrender: onTextRender, spellcheck: "false", autocorrect: "off", autocomplete: "off", autocapitalize: "off" }),
            m$1("label", { id: "error-text" }, state.errorText),
            m$1("div", { id: "buttons" },
                m$1(Button, { onclick: showDialog },
                    "Reset changes",
                    dialog),
                m$1(Button, { onclick: apply }, "Apply"),
                m$1(Button, { class: "preview-design-button", onclick: toggleDesign }, previewButtonText)),
            m$1("p", { id: "description" },
                "Read about this tool ",
                m$1("strong", null,
                    m$1("a", { href: DEVTOOLS_DOCS_URL, target: "_blank", rel: "noopener noreferrer" }, "here")),
                ". If a ",
